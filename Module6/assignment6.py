...
#
# .. your code here ..
X = pd.read_csv(r"C:\Users\diepencjv\repos\DAT210x\Module6\dataset-har-PUC-Rio-ugulino.csv", delimiter=';')
...
for col in ['how_tall_in_meters', 'body_mass_index']:
    X[col] = pd.to_numeric([x.replace(',', '.') for x in X[col]], errors='coerce')
