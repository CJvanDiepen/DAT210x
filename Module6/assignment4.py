...
#
# .. your code here ..
X = pd.read_csv(r"C:\Users\diepencjv\repos\DAT210x\Module6\Datasets\wheat.data", header=0, index_col=0)
...
# .. your code here ..
y = X['wheat_type']
y = y.map({'canadian':1,'kama':0,'rosa':2})
...
for i in np.arange(9,0,-1):
    dtc = DecisionTreeClassifier(max_depth=i, random_state=2)
    
    benchmark(dtc, X_train, X_test, y_train, y_test, 'DecisionTreeClassifier, max_depth: %d' % i)
