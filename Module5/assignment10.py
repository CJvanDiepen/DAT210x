...
for i in range(0, 50):
    filename = r'C:\Users\Sjaak\Documents\DAT210x\Cached Datasets\free-spoken-digit-dataset-master\recordings\0_jackson_%d.wav' % i 
    wavinfo = wavfile.read(filename)
    zero.append(wavinfo[1])
